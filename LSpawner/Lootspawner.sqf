...
_chperSpot = 45;					//Chance (in %) if a spot gets loot. Will be considered before 'spawnClassChance_list'
...
[0, 7, 10, 10, 9, 11],	// civil
[1, 11, 15, 18, 12, 9],	// military
[2, 5, 10, 14, 12, 15],	// industrial
[3, 6, 15, 15, -1, -1]		// research
];
