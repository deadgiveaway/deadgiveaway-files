...
_chperSpot = 30;					//Chance (in %) if a spot gets loot. Will be considered before 'spawnClassChance_list'
...
[0, 13, 21, 36, 18, 22],	// civil
[1, 22, 36, 36, 26, 18],	// military
[2, 10, 21, 36, 26, 36],	// industrial
